...
function h5bs_enqueue_scripts()
{
  ...
  wp_enqueue_script('bootmodal', "https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js", ['jquery'], '5.2.3', true);
  // wp_enqueue_script('popper', "https://cdnjs.cloudflare.com/ajax/libs/popper.js/2.11.7/umd/popper.min.js", ['jquery'], '2.11.7', true);
